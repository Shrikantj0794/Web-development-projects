...
function icon_element_admin_init() {
	...
	$options = array(
		...
		array(
			...
			'type'    => 'checkbox',
			'default' => '',
			'name'    => esc_html__( 'Chart', 'icon-element' ),
			'pro'	  => 'yes',
		...
		array(
			...
			'type'    => 'checkbox',
			'default' => '',
			'name'    => esc_html__( 'Map Icon', 'icon-element' ),
			'pro'	  => 'yes',
		...
		array(
			...
			'type'    => 'checkbox',
			'default' => '',
			'name'    => esc_html__( 'Devicon', 'icon-element' ),
			'pro'	  => 'yes',
		...
		array(
			...
			'type'    => 'checkbox',
			'default' => '',
			'name'    => esc_html__( 'Android material', 'icon-element' ),
			'pro'	  => 'yes',
		...
		array(
			...
			'type'    => 'checkbox',
			'default' => '',
			'name'    => esc_html__( 'Android holo', 'icon-element' ),
			'pro'	  => 'yes',
			'preview' => 'https://www.androidicons.com/'	
		),
		...
		array(
			...
			'type'    => 'checkbox',
			'default' => '',
			'name'    => esc_html__( 'Evaicon', 'icon-element' ),
			'pro'	  => 'yes',
		...
		array(
			...
			'type'    => 'checkbox',
			'default' => '',
			'name'    => esc_html__( 'Iconi cool', 'icon-element' ),
			'pro'	  => 'yes',
		...
		array(
			...
			'type'    => 'checkbox',
			'default' => '',
			'name'    => esc_html__( 'Elusive', 'icon-element' ),
			'pro'	  => '',
		...
		array(
			...
			'type'    => 'checkbox',
			'default' => '',
			'name'    => esc_html__( 'Obicon', 'icon-element' ),
			'pro'	  => '',
		...
		array(
			...
			'type'    => 'checkbox',
			'default' => '',
			'name'    => esc_html__( 'Web icon', 'icon-element' ),
			'pro'	  => '',
		...
		array(
			...
			'type'    => 'checkbox',
			'default' => '',
			'name'    => esc_html__( 'Feather', 'icon-element' ),
			'pro'	  => '',
		...
		array(
			...
			'type'    => 'checkbox',
			'default' => '',
			'name'    => esc_html__( 'Element plus', 'icon-element' ),
			'pro'	  => 'yes',
		...
		array(
			...
			'type'    => 'checkbox',
			'default' => '',
			'name'    => esc_html__( 'Iconsax Bold', 'icon-element' ),
			'pro'	  => '',
